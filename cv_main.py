...
# using static image
cvImage = cv.imread(r"C:\Users\Hephzibah\Pictures\Camera Roll\WIN_20250328_14_35_45_Pro.jpg")  # Load a constant image
...
##############################################
    ...
    def cv_InitComputerVision(self):
        ...
        cv.imwrite("sandbox.jpg", self.latestSandboxImage)
